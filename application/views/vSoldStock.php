...
<h2>Current Stock Sold</h2>
<p>
    <table width="100%" align="center" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="tbl">
    <tr>
    <td colspan="6" height="22" align="center" bgcolor="#4f4f4f">Current Cars Sold</td>
    </tr>
    <tr>
    ...
    <?php
		foreach($results as $row){
			...
			echo "<td align=center>";
			echo "<img src=/~bg09xm/LVMC/assests/images/carlogo/" . $row->Make . ".png width=30 height=30>" ;
			echo "</td>";
